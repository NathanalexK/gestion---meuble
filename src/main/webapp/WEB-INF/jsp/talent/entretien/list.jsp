    ...
    <div class="table-responsive text-nowrap">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a href="/personnel/insert-personnel?id=<%=e.getIdCv().getId()%>&&entretien=<%= e.getId()%>"><button class="btn btn-primary">Valider</button></a>
                    <a href="/entretien/refuser?id=<%=e.getId()%>"><button class="btn btn-primary">refuser</button></a>
                </td>
            </tr>
            <%
                }
