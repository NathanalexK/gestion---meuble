    ...
    <div class="flex">
        <div class="d-flex justify-content-center">
            <div class="card mb-4 w-50">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="poste_mere">Poste mere : </label>
                        <select name="fournisseur" id="poste_mere" class="form-select">
                            <%
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="produit">Nom poste : </label>
